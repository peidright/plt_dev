...
请求查询投资者持仓明细响应'''
    ...
    def OnRtnFundOutCTPAccount(self, pFundIOCTPAccount):
        '''
资金转出CTP通知'''
        pass

    def OnRtnFundIntoCTPAccount(self, pFundIOCTPAccount):
        '''
资金转入CTP通知'''
        pass
...
用户口令更新请求响应'''
    ...
    def OnRspQryFundIOCTPAccount(self, pFundIOCTPAccount, pRspInfo, nRequestID, bIsLast):
        '''
资金转入转出CTP查询应答'''
        pass
...
登出请求响应'''
    ...
    def OnRspFundOutCTPAccount(self, pRspFundIOCTPAccount, pRspInfo, nRequestID, bIsLast):
        '''
资金转出CTP请求应答'''
        pass
...
报单操作请求'''
    ...
    def ReqFundOutCTPAccount(self, pReqFundIOCTPAccount, nRequestID):
        '''
资金转出CTP请求请求'''
        return _ctp_Trader.ReqFundOutCTPAccount(self.api_ptr, pReqFundIOCTPAccount, nRequestID)
...
@remark “tcp”代表传输协议，“127.0.0.1”代表服务器地址。”17001”代表服务器端口号。'''
    ...
    def ReqQryBondInterest(self, pQryBondInterest, nRequestID):
        '''
请求查询债券利息'''
        return _ctp_Trader.ReqQryBondInterest(self.api_ptr, pQryBondInterest, nRequestID)
...
资金账户口令更新请求'''
    ...
    def ReqQryFundIOCTPAccount(self, pQryFundIOCTPAccount, nRequestID):
        '''
资金转入转出CTP查询请求'''
        return _ctp_Trader.ReqQryFundIOCTPAccount(self.api_ptr, pQryFundIOCTPAccount, nRequestID)
