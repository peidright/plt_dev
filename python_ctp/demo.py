...
class myMdSpi(MdSpi):
    ...
    def OnRspUserLogin(self, userlogin, info, rid, is_last):
        ...
        if is_last and not self.isErrorRspInfo(info):
            ...
            self.subscribe_market_data(self.instruments, "S") # 上期所

    def subscribe_market_data(self, instruments, exchange_id):
        self.api.SubscribeMarketData(instruments, exchange_id) 
