...
static PyObject* Trader_ReqFundOutCTPAccount(PyObject * self, PyObject * args){
  CZQThostFtdcTraderApi * user = (CZQThostFtdcTraderApi *) PyInt_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pReqFundIOCTPAccount = PyTuple_GET_ITEM(args, 1);
  CZQThostFtdcReqFundIOCTPAccountField* pReqFundIOCTPAccount = from_CZQThostFtdcReqFundIOCTPAccountField(py_pReqFundIOCTPAccount);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyInt_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqFundOutCTPAccount(pReqFundIOCTPAccount, nRequestID));
  free(pReqFundIOCTPAccount);
  return ret;
}
...
static PyObject* Trader_ReqQryBondInterest(PyObject * self, PyObject * args){
  CZQThostFtdcTraderApi * user = (CZQThostFtdcTraderApi *) PyInt_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQryBondInterest = PyTuple_GET_ITEM(args, 1);
  CZQThostFtdcQryBondInterestField* pQryBondInterest = from_CZQThostFtdcQryBondInterestField(py_pQryBondInterest);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyInt_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQryBondInterest(pQryBondInterest, nRequestID));
  free(pQryBondInterest);
  return ret;
}
...
static PyObject* Trader_ReqQryFundIOCTPAccount(PyObject * self, PyObject * args){
  CZQThostFtdcTraderApi * user = (CZQThostFtdcTraderApi *) PyInt_AsLong(PyTuple_GET_ITEM(args, 0));
  PyObject * py_pQryFundIOCTPAccount = PyTuple_GET_ITEM(args, 1);
  CZQThostFtdcQryFundIOCTPAccountField* pQryFundIOCTPAccount = from_CZQThostFtdcQryFundIOCTPAccountField(py_pQryFundIOCTPAccount);
  PyObject * py_nRequestID = PyTuple_GET_ITEM(args, 2);
  int nRequestID = PyInt_AsLong(py_nRequestID);
  PyObject * ret = Py_BuildValue("i", user->ReqQryFundIOCTPAccount(pQryFundIOCTPAccount, nRequestID));
  free(pQryFundIOCTPAccount);
  return ret;
}
...
extern "C" MD_API_EXPORT void init_ctp_Trader()
{
   static PyMethodDef mbMethods[] = {
     ...
     {"ReqFundOutCTPAccount", Trader_ReqFundOutCTPAccount, METH_VARARGS} ,
     ...
     {"ReqQryBondInterest", Trader_ReqQryBondInterest, METH_VARARGS} ,
     {"ReqTradingAccountPasswordUpdate", Trader_ReqTradingAccountPasswordUpdate, METH_VARARGS} ,
     {"ReqQryFundIOCTPAccount", Trader_ReqQryFundIOCTPAccount, METH_VARARGS} ,
