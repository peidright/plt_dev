...
void MySpiWrapper::OnRtnFundOutCTPAccount(CZQThostFtdcFundIOCTPAccountField* pFundIOCTPAccount){
  PyGILState_STATE gstate;
  gstate=PyGILState_Ensure();

  if (!PyObject_CallMethod(py_spi, (char*)"OnRtnFundOutCTPAccount", (char*)"N", new_CZQThostFtdcFundIOCTPAccountField(pFundIOCTPAccount))){
    PyErr_Print();
  }
...
void MySpiWrapper::OnRtnFundIntoCTPAccount(CZQThostFtdcFundIOCTPAccountField* pFundIOCTPAccount){
  PyGILState_STATE gstate;
  gstate=PyGILState_Ensure();

  if (!PyObject_CallMethod(py_spi, (char*)"OnRtnFundIntoCTPAccount", (char*)"N", new_CZQThostFtdcFundIOCTPAccountField(pFundIOCTPAccount))){
    PyErr_Print();
  }
...
void MySpiWrapper::OnRspQryFundIOCTPAccount(CZQThostFtdcFundIOCTPAccountField* pFundIOCTPAccount, CZQThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast){
  PyGILState_STATE gstate;
  gstate=PyGILState_Ensure();

  if (!PyObject_CallMethod(py_spi, (char*)"OnRspQryFundIOCTPAccount", (char*)"NNib", new_CZQThostFtdcFundIOCTPAccountField(pFundIOCTPAccount), new_CZQThostFtdcRspInfoField(pRspInfo), nRequestID, bIsLast)){
    PyErr_Print();
  }
...
void MySpiWrapper::OnRspFundOutCTPAccount(CZQThostFtdcRspFundIOCTPAccountField* pRspFundIOCTPAccount, CZQThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast){
  PyGILState_STATE gstate;
  gstate=PyGILState_Ensure();

  if (!PyObject_CallMethod(py_spi, (char*)"OnRspFundOutCTPAccount", (char*)"NNib", new_CZQThostFtdcRspFundIOCTPAccountField(pRspFundIOCTPAccount), new_CZQThostFtdcRspInfoField(pRspInfo), nRequestID, bIsLast)){
    PyErr_Print();
  }
...
void MySpiWrapper::OnRspQryBondInterest(CZQThostFtdcBondInterestField* pBondInterest, CZQThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast){
  PyGILState_STATE gstate;
  gstate=PyGILState_Ensure();

  if (!PyObject_CallMethod(py_spi, (char*)"OnRspQryBondInterest", (char*)"NNib", new_CZQThostFtdcBondInterestField(pBondInterest), new_CZQThostFtdcRspInfoField(pRspInfo), nRequestID, bIsLast)){
    PyErr_Print();
  }
