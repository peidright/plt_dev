...
PyObject * new_CZQThostFtdcTradingAccountField(CZQThostFtdcTradingAccountField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcTradingAccountField", (char*)"dddddddddddsddddddddddddiddssddddddddddddddddd",
p->FrozenTransferFee, p->Mortgage, p->ExchangeDeliveryMargin, p->FrozenMargin, p->WithdrawQuota, p->PositionProfit, p->TransferFee, p->Commission, p->Interest, p->ShortSellingAmount, p->CashIn, p->AccountID, p->Available, p->LowLimitRatio, p->PreCredit, p->PreMortgage, p->CreditRatio, p->MarginTradingAvail, p->CreditAmount, p->InterestBase, p->ExchangeMargin, p->ConversionAmount, p->SSStockValue, p->PreMargin, p->SettlementID, p->DeliveryMargin, p->BondRepurchaseAmount, p->TradingDay, p->BrokerID, p->FrozenCash, p->Withdraw, p->ReverseRepurchaseAmount, p->StampTax, p->Balance, p->FrozenStampTax, p->Reserve, p->PreDeposit, p->ShortSellingAvail, p->Credit, p->PreBalance, p->CurrMargin, p->FrozenCommission, p->CloseProfit, p->StockValue, p->MarginTradingAmount, p->Deposit);
}
...
CZQThostFtdcTradeField * from_CZQThostFtdcTradeField(PyObject * p){
  ...
  //THOST_FTDC_D_Rationed -> 'f', 配股
  //THOST_FTDC_D_PledgeBondOut -> 'e', 债券质押出库,深圳无质押代码,以此区分是质押入库
  //THOST_FTDC_D_ETFPur -> '2', ETF申购
  //THOST_FTDC_D_ShortSell -> '5', 融券卖出
  //THOST_FTDC_D_TransferSecuritiesOut -> 'b', 担保品划转出信用账户
  //THOST_FTDC_D_PledgeBondIn -> 'd', 债券质押入库,深圳无质押代码,以此区分是质押入库
...
PyObject * new_CZQThostFtdcQryInvestorPositionDetailField(CZQThostFtdcQryInvestorPositionDetailField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcQryInvestorPositionDetailField", (char*)"ssss",
...
//资金转入转出CTP
PyObject * new_CZQThostFtdcFundIOCTPAccountField(CZQThostFtdcFundIOCTPAccountField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcFundIOCTPAccountField", (char*)"issiisssiscssdss",
p->PlateSerial, p->TradingDay, p->ErrorMsg, p->CTPSerial, p->ErrorID, p->UserID, p->SettlementSerial, p->InvestorID, p->SessionID, p->BrokerID, p->FundDirection, p->TradeTime, p->Password, p->TradeAmount, p->Digest, p->AccountID);
}
CZQThostFtdcFundIOCTPAccountField * from_CZQThostFtdcFundIOCTPAccountField(PyObject * p){
  CZQThostFtdcFundIOCTPAccountField *t = (CZQThostFtdcFundIOCTPAccountField *)calloc(1, sizeof(CZQThostFtdcFundIOCTPAccountField));
  //转账平台流水号
  t->PlateSerial =   PyInt_AsLong(PyObject_GetAttrString(p, "PlateSerial"));
  //交易日
  strcpy(t->TradingDay, PyString_AsString(PyObject_GetAttrString(p, "TradingDay")));
  ...
  strcpy(t->ErrorMsg, PyString_AsString(PyObject_GetAttrString(p, "ErrorMsg")));
  //CTP核心流水号
  t->CTPSerial =   PyInt_AsLong(PyObject_GetAttrString(p, "CTPSerial"));
  //错误代码
  t->ErrorID =   PyInt_AsLong(PyObject_GetAttrString(p, "ErrorID"));
  //用户代码
  strcpy(t->UserID, PyString_AsString(PyObject_GetAttrString(p, "UserID")));
  //第三方流水号
  strcpy(t->SettlementSerial, PyString_AsString(PyObject_GetAttrString(p, "SettlementSerial")));
  //投资者代码
  strcpy(t->InvestorID, PyString_AsString(PyObject_GetAttrString(p, "InvestorID")));
  //会话编号
  t->SessionID =   PyInt_AsLong(PyObject_GetAttrString(p, "SessionID"));
...
//客户最大持仓限制
PyObject * new_CZQThostFtdcMaxStockPositionLimitField(CZQThostFtdcMaxStockPositionLimitField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcMaxStockPositionLimitField", (char*)"ssdssc",
p->InstrumentID, p->ExchangeID, p->Ratio, p->InvestorID, p->BrokerID, p->CapitalStockType);
}
CZQThostFtdcMaxStockPositionLimitField * from_CZQThostFtdcMaxStockPositionLimitField(PyObject * p){
  CZQThostFtdcMaxStockPositionLimitField *t = (CZQThostFtdcMaxStockPositionLimitField *)calloc(1, sizeof(CZQThostFtdcMaxStockPositionLimitField));
  //合约代码
  strcpy(t->InstrumentID, PyString_AsString(PyObject_GetAttrString(p, "InstrumentID")));
  //交易所代码
  strcpy(t->ExchangeID, PyString_AsString(PyObject_GetAttrString(p, "ExchangeID")));
  //最大持仓数量占股本的比例
  t->Ratio =   PyFloat_AsDouble(PyObject_GetAttrString(p, "Ratio"));
  //投资者代码
  strcpy(t->InvestorID, PyString_AsString(PyObject_GetAttrString(p, "InvestorID")));
  //经纪公司代码
  strcpy(t->BrokerID, PyString_AsString(PyObject_GetAttrString(p, "BrokerID")));
  //股本类型
  //enum类型
  //THOST_FTDC_CPTSTOCK_TOTALSTOCK -> '1', 总通股本
  //THOST_FTDC_CPTSTOCK_CIRCULATION -> '2', 流通股本
  t->CapitalStockType =   PyString_AsString(PyObject_GetAttrString(p, "CapitalStockType"))[0];
...
PyObject * new_CZQThostFtdcTransferSerialField(CZQThostFtdcTransferSerialField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcTransferSerialField", (char*)"sssssssssisicisssscssdcissddsc",
p->BankNewAccount, p->BrokerBranchID, p->UserID, p->TradeTime, p->OperatorCode, p->AccountID, p->BankAccount, p->TradeCode, p->BankBranchID, p->SessionID, p->BankID, p->PlateSerial, p->FutureAccType, p->ErrorID, p->BankSerial, p->IdentifiedCardNo, p->TradingDay, p->BrokerID, p->IdCardType, p->TradeDate, p->CurrencyID, p->BrokerFee, p->BankAccType, p->FutureSerial, p->InvestorID, p->ErrorMsg, p->CustFee, p->TradeAmount, p->Digest, p->AvailabilityFlag);
}
...
//债券利息
PyObject * new_CZQThostFtdcBondInterestField(CZQThostFtdcBondInterestField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcBondInterestField", (char*)"sssd",
p->InstrumentID, p->TradingDay, p->ExchangeID, p->Interest);
}
CZQThostFtdcBondInterestField * from_CZQThostFtdcBondInterestField(PyObject * p){
  CZQThostFtdcBondInterestField *t = (CZQThostFtdcBondInterestField *)calloc(1, sizeof(CZQThostFtdcBondInterestField));
  //合约代码
  strcpy(t->InstrumentID, PyString_AsString(PyObject_GetAttrString(p, "InstrumentID")));
  //交易日
  strcpy(t->TradingDay, PyString_AsString(PyObject_GetAttrString(p, "TradingDay")));
...
PyObject * new_CZQThostFtdcSyncingTradingAccountField(CZQThostFtdcSyncingTradingAccountField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcSyncingTradingAccountField", (char*)"dddddddddddsddddddddddddiddssddddddddddddddddd",
p->FrozenTransferFee, p->Mortgage, p->ExchangeDeliveryMargin, p->FrozenMargin, p->WithdrawQuota, p->PositionProfit, p->TransferFee, p->Commission, p->Interest, p->ShortSellingAmount, p->CashIn, p->AccountID, p->Available, p->LowLimitRatio, p->PreCredit, p->PreMortgage, p->CreditRatio, p->MarginTradingAvail, p->CreditAmount, p->InterestBase, p->ExchangeMargin, p->ConversionAmount, p->SSStockValue, p->PreMargin, p->SettlementID, p->DeliveryMargin, p->BondRepurchaseAmount, p->TradingDay, p->BrokerID, p->FrozenCash, p->Withdraw, p->ReverseRepurchaseAmount, p->StampTax, p->Balance, p->FrozenStampTax, p->Reserve, p->PreDeposit, p->ShortSellingAvail, p->Credit, p->PreBalance, p->CurrMargin, p->FrozenCommission, p->CloseProfit, p->StockValue, p->MarginTradingAmount, p->Deposit);
}
...
PyObject * new_CZQThostFtdcInvestorPositionDetailField(CZQThostFtdcInvestorPositionDetailField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcInvestorPositionDetailField", (char*)"dcciddcdididissisdsddsidss",
p->ExchMargin, p->TradeType, p->HedgeFlag, p->PledgeInFrozenPosition, p->TransferFee, p->Commission, p->Direction, p->CloseAmount, p->RepurchasePosition, p->OpenPrice, p->Volume, p->LastSettlementPrice, p->CloseVolume, p->InstrumentID, p->ExchangeID, p->SettlementID, p->TradingDay, p->Amount, p->BrokerID, p->StampTax, p->Margin, p->TradeID, p->PledgeInPosition, p->SettlementPrice, p->InvestorID, p->OpenDate);
}
...
//查询资金转入转出CTP
PyObject * new_CZQThostFtdcQryFundIOCTPAccountField(CZQThostFtdcQryFundIOCTPAccountField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcQryFundIOCTPAccountField", (char*)"ss",
p->BrokerID, p->AccountID);
}
CZQThostFtdcQryFundIOCTPAccountField * from_CZQThostFtdcQryFundIOCTPAccountField(PyObject * p){
  CZQThostFtdcQryFundIOCTPAccountField *t = (CZQThostFtdcQryFundIOCTPAccountField *)calloc(1, sizeof(CZQThostFtdcQryFundIOCTPAccountField));
  //经纪公司代码
  strcpy(t->BrokerID, PyString_AsString(PyObject_GetAttrString(p, "BrokerID")));
  //投资者资金帐号
  strcpy(t->AccountID, PyString_AsString(PyObject_GetAttrString(p, "AccountID")));
...
PyObject * new_CZQThostFtdcInstrumentCommissionRateField(CZQThostFtdcInstrumentCommissionRateField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcInstrumentCommissionRateField", (char*)"ssdcddsddscddd",
p->InstrumentID, p->ExchangeID, p->TradeFeeByMoney, p->Direction, p->MinTradeFee, p->StampTaxRateByMoney, p->InvestorID, p->MarginByMoney, p->StampTaxRateByVolume, p->BrokerID, p->InvestorRange, p->TransferFeeRateByVolume, p->TransferFeeRateByMoney, p->TradeFeeByVolume);
}
...
//资金转入转出请求
PyObject * new_CZQThostFtdcReqFundIOCTPAccountField(CZQThostFtdcReqFundIOCTPAccountField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcReqFundIOCTPAccountField", (char*)"isisssisssdss",
p->PlateSerial, p->TradingDay, p->CTPSerial, p->UserID, p->SettlementSerial, p->InvestorID, p->SessionID, p->BrokerID, p->TradeTime, p->Password, p->TradeAmount, p->Digest, p->AccountID);
}
CZQThostFtdcReqFundIOCTPAccountField * from_CZQThostFtdcReqFundIOCTPAccountField(PyObject * p){
  CZQThostFtdcReqFundIOCTPAccountField *t = (CZQThostFtdcReqFundIOCTPAccountField *)calloc(1, sizeof(CZQThostFtdcReqFundIOCTPAccountField));
  //转账平台流水号
  t->PlateSerial =   PyInt_AsLong(PyObject_GetAttrString(p, "PlateSerial"));
  //交易日
  strcpy(t->TradingDay, PyString_AsString(PyObject_GetAttrString(p, "TradingDay")));
...
//资金转入转出应答
PyObject * new_CZQThostFtdcRspFundIOCTPAccountField(CZQThostFtdcRspFundIOCTPAccountField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcRspFundIOCTPAccountField", (char*)"isisssiscssdss",
p->PlateSerial, p->TradingDay, p->CTPSerial, p->UserID, p->SettlementSerial, p->InvestorID, p->SessionID, p->BrokerID, p->FundDirection, p->TradeTime, p->Password, p->TradeAmount, p->Digest, p->AccountID);
}
CZQThostFtdcRspFundIOCTPAccountField * from_CZQThostFtdcRspFundIOCTPAccountField(PyObject * p){
  CZQThostFtdcRspFundIOCTPAccountField *t = (CZQThostFtdcRspFundIOCTPAccountField *)calloc(1, sizeof(CZQThostFtdcRspFundIOCTPAccountField));
  //转账平台流水号
  t->PlateSerial =   PyInt_AsLong(PyObject_GetAttrString(p, "PlateSerial"));
  //交易日
  strcpy(t->TradingDay, PyString_AsString(PyObject_GetAttrString(p, "TradingDay")));
...
PyObject * new_CZQThostFtdcSyncingInstrumentCommissionRateField(CZQThostFtdcSyncingInstrumentCommissionRateField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcSyncingInstrumentCommissionRateField", (char*)"ssdcddsddscddd",
p->InstrumentID, p->ExchangeID, p->TradeFeeByMoney, p->Direction, p->MinTradeFee, p->StampTaxRateByMoney, p->InvestorID, p->MarginByMoney, p->StampTaxRateByVolume, p->BrokerID, p->InvestorRange, p->TransferFeeRateByVolume, p->TransferFeeRateByMoney, p->TradeFeeByVolume);
}
...
PyObject * new_CZQThostFtdcQryProductField(CZQThostFtdcQryProductField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcQryProductField", (char*)"ss",
p->ExchangeID, p->ProductID);
}
...
//查询债券利息
PyObject * new_CZQThostFtdcQryBondInterestField(CZQThostFtdcQryBondInterestField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcQryBondInterestField", (char*)"ss",
p->InstrumentID, p->ExchangeID);
}
CZQThostFtdcQryBondInterestField * from_CZQThostFtdcQryBondInterestField(PyObject * p){
  CZQThostFtdcQryBondInterestField *t = (CZQThostFtdcQryBondInterestField *)calloc(1, sizeof(CZQThostFtdcQryBondInterestField));
  //合约代码
  strcpy(t->InstrumentID, PyString_AsString(PyObject_GetAttrString(p, "InstrumentID")));
  //交易所代码
  strcpy(t->ExchangeID, PyString_AsString(PyObject_GetAttrString(p, "ExchangeID")));
...
PyObject * new_CZQThostFtdcInvestorPositionField(CZQThostFtdcInvestorPositionField * p){
  return PyObject_CallMethod(mod, (char*)"CZQThostFtdcInvestorPositionField", (char*)"ddicdiddiidddiciiiidiiiiddscsidiiisddsddddiddddsdddd",
p->MarginTradeAmount, p->ShortFrozenAmount, p->TodaySSPosition, p->HedgeFlag, p->PositionProfit, p->PledgeInFrozenPosition, p->TransferFee, p->Commission, p->ShortSellVolume, p->TodayPurRedVolume, p->CashIn, p->PreSettlementPrice, p->CloseAmount, p->PledgeInPosition, p->PosiDirection, p->RepurchasePosition, p->MarginTradeVolume, p->YdPosition, p->MarginTradeFrozenVolume, p->ConversionRate, p->ShortSellFrozenVolume, p->OpenVolume, p->TodayMTPosition, p->CloseVolume, p->ConversionAmount, p->SSStockValue, p->InstrumentID, p->PositionDate, p->ExchangeID, p->SettlementID, p->MarginTradeFrozenAmount, p->ShortFrozen, p->LongFrozen, p->TodayPosition, p->TradingDay, p->PositionCost, p->MarginTradeConversionAmount, p->BrokerID, p->FrozenCash, p->OpenAmount, p->OpenCost, p->StampTax, p->Position, p->ExchangeMargin, p->ShortSellFrozenAmount, p->SettlementPrice, p->LongFrozenAmount, p->InvestorID, p->ShortSellConversionAmount, p->CloseProfit, p->StockValue, p->ShortSellAmount);
}
